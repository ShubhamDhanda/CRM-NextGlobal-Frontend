...
class UpdateBudgetDialog extends StatefulWidget{
  ...
  UpdateBudgetDialog({super.key, required this.mp});

  @override
  State<StatefulWidget> createState() => _UpdateBudgetDialogState(mp: mp);
}
...
class _UpdateBudgetDialogState extends State<UpdateBudgetDialog>{
  ...
  _UpdateBudgetDialogState({required this.mp}){
    cityId = mp["cityId"];
    city.text = mp["city"];
    department.text = mp["department"];
    departmentId = mp["departmentId"];
    category.text = mp["projectCategory"];
    categoryId = mp["projectCatId"];
    projectName.text = mp["projectName"];
    budgetCategory = mp["budgetCategory"];
    budgetAmount.text = mp["budgetAmount"].toString();
  }
  ...
  void _postData() async {
    try{
      if(validate() == true){
        dynamic res = await apiClient.updateBudget(mp["budgetId"], cityId.toString(), departmentId.toString(), categoryId.toString(), projectName.text, budgetCategory.toString(), budgetAmount.text);

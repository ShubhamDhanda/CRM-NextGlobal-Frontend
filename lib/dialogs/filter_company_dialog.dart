...
class FilterCompanyDialog extends StatefulWidget{
  List<String> cat;
  FilterCompanyDialog({super.key, required this.cat});

  @override
  State<StatefulWidget> createState() =>_FilterCompanyDialogState(cat: cat);
}

class _FilterCompanyDialogState extends State<FilterCompanyDialog>{
  List<String> cat;
  List<String> prev = [];

  _FilterCompanyDialogState({required this.cat}) {
    prev.addAll(cat);
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
            ...
            children: [
              const Center(child: Text("Filter Companies")),
              GestureDetector(
                  onTap: () async {
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Checkbox(
                      value: cat.contains("Manufacturer"),
                      onChanged: (value) {
                        setState(() {
                          if(value!){
                ...
                Row(
                  children: [
                    Checkbox(
                      value: cat.contains("Distributor"),
                      onChanged: (value) {
                        setState(() {
                          if(value!){
                            cat.add("Distributor");

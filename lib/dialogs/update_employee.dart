...
class updateEmployeeDialog extends StatefulWidget {
  ...
  const updateEmployeeDialog({Key? key, required this.mp}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _updateEmployeeDialogState(mp: mp);
}
...
class _updateEmployeeDialogState extends State<updateEmployeeDialog> {
  ...
  _updateEmployeeDialogState({required this.mp}) {
    if(mp["department"] != "") {
    ...
    jobTitleId = mp["jobTitleId"];
    emailWork.text = mp["emailWork"];
    emailPersonal.text = mp["emailPersonal"];
    directManager.text = mp["directManager"];
    directManagerID = mp["directManagerId"];
    username.text = mp["username"];
    joiningDate.text = mp["joiningDate"];
    ...
    expertise.text = mp["expertise"];
    resume.text = mp["resume"];
    softwarePrivilege.text = mp["softwarePrivileges"];
    webpage.text = mp["webpage"];
    notes.text = mp["notes"];
    attachment.text = mp["attachments"];
    proficiency.text = mp["proficiency"];
    interest.text = mp["interests"];
    cocurricular.text = mp["cocurricular"];
    trainings.text = mp["trainings"];
    ...
    travel.text = mp["travel"];
    spouse.text = mp["spouse"];
    children.text = mp["children"];
    tv.text = mp["tvShow"];
    movie.text = mp["movies"];
    actor.text = mp["actor"];
    dislikes.text = mp["dislikes"];
    strengths.text = mp["strength"];
    weaknesses.text = mp["weakness"];
    socialActiveIndex.text = mp["socialActiveIndex"].toString();
  }
...
print(res);
  ...
  bool validate() {
    if(firstName.text=="" || department.toString()=="" || jobTitle.text=="" || emailWork.text == "" || directManager.text=="" || businessPhone.text == "" || city.text == ""){
